...
x selection[2];
x selection[3];
ctrl @ ctrl @ ctrl @ ctrl @ rz(-1.5707963267948966) selection[0], selection[1], selection[2], selection[3], phase_anc;
ctrl @ ctrl @ ctrl @ ctrl @ z selection[0], selection[1], selection[2], selection[3], system[0];
ctrl @ ctrl @ ctrl @ ctrl @ z selection[0], selection[1], selection[2], selection[3], system[1];
x selection[3];
x selection[2];
...
x selection[2];
x selection[3];
ctrl @ ctrl @ ctrl @ ctrl @ sdg selection[0], selection[1], selection[2], selection[3], system[0];
...
ctrl @ ctrl @ ctrl @ ctrl @ sdg selection[0], selection[1], selection[2], selection[3], system[1];
...
x selection[3];
ctrl @ ctrl @ ctrl @ ctrl @ rz(3.141592653589793) selection[0], selection[1], selection[2], selection[3], phase_anc;
ctrl @ ctrl @ ctrl @ ctrl @ z selection[0], selection[1], selection[2], selection[3], system[1];
x selection[3];
