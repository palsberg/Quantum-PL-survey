"""TFIM via OpenQASM 3 LCU block executed on a Qiskit backend."""
...
def run_simulation(config: Dict[str, Any]):
    ...
    # Infer register sizes from the imported circuit.
    ...
    if norm == 0:
        raise RuntimeError("OpenQASM TFIM LCU produced zero amplitude on |sel=0, phase=1, junk=0>.")
