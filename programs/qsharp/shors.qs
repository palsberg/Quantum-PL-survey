namespace HamiltonianSimulation.Shors{
    ...
    operation QPESubroutine(N: Int, a: Int, t: Int) : Unit {
        Fact(
            GreatestCommonDivisorI(a, N) == 1,
            $"a={a} and N={N} must be co-prime. Try a different value of a."
        );
    ...
    internal operation ApplyOrderFindingOracle(
        ...
        // The oracle we use for order finding implements |x> -> |xa mod N>. We
