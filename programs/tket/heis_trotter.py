"""Heisenberg XXX via Lie–Trotterization in pytket."""
...
def run_simulation(config: Dict[str, Any]):
    ...
    circ, _ = common.trotterize_heisenberg_xxx(num_sites, J, field, total_time, steps)
    return common.simulate_statevector(circ)
